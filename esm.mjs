...
const RobloxClient = (await import("./dist/lib/RobloxClient.js")).default.default;
...
const ChatInputCommandInteraction = (await import("./dist/lib/structures/ChatInputCommandInteraction.js")).default.default;
