    ...
    static from<T extends AnyInteraction = AnyInteraction>(data: RawInteraction, client: Client): T {
        switch (data.type) {
            ...
            case InteractionTypes.APPLICATION_COMMAND: {
                return new ChatInputCommandInteraction(data as RawApplicationCommandInteraction, client) as T;
            }
...
const ChatInputCommandInteraction = (require("./ChatInputCommandInteraction") as typeof import("./ChatInputCommandInteraction")).default
